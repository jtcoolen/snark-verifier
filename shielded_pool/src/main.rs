...
fn emit_final_wrap_evm_stateful_loop_bench(
    ...
    let pairing_addon_contract_name = "ShieldedPoolFinalAccumulatorPairingAddon";
    let uhf_addon_contract_name = "ShieldedPoolUhfAddon";
    let pairing_addon_solidity =
        snark_verifier_sdk::snark_verifier::loader::evm::final_accumulator_pairing_addon_solidity(
            pairing_addon_contract_name,
            &pairing_g2_words,
            &pairing_minus_tau_words,
        );
    let uhf_addon_solidity =
        snark_verifier_sdk::snark_verifier::loader::evm::uhf_addon_solidity(
            uhf_addon_contract_name,
        );
...
{pairing_addon_solidity}
{uhf_addon_solidity}

contract ShieldedPoolStatefulVerifier is {pairing_addon_contract_name}, {uhf_addon_contract_name} {{
...
{client_public_items_encode_args}
    ...
    function verifyAndUpdate(
        ...
        uint256 hybridGamma = _uhf(hybridSeed, l2BlockMetadata, FIELD_MODULUS);
