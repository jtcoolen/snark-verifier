...
pub struct PermutationCommitments<F: PrimeField, CS: PolynomialCommitmentScheme<F>> {
    pub permuted_input_commitment: CS::Commitment,
    pub permuted_table_commitment: CS::Commitment,
}

#[derive(Debug, Clone)]
pub struct Committed<F: PrimeField, CS: PolynomialCommitmentScheme<F>> {
    pub permuted: PermutationCommitments<F, CS>,
    pub product_commitment: CS::Commitment,
}

#[derive(Debug, Clone)]
pub struct Evaluated<F: PrimeField, CS: PolynomialCommitmentScheme<F>> {
    pub committed: Committed<F, CS>,
    pub product_eval: F,
    pub product_next_eval: F,
